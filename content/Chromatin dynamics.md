...
### [[📑 Journal reading - Locality of contacts determines the subdiffusion exponents in polymeric models of chromatin|Locality of contacts determines the subdiffusion exponents in polymeric models of chromatin]]
**Marchi, Zhan & Tiana (2023)**, *Locality of contacts determines the subdiffusion exponents in polymeric models of chromatin*, **Phys. Rev. E 107, 064406**. arXiv:2306.08301
	...
	- Findings: Rouse + excluded volume baseline $\alpha \approx 0.55$. Local contact → Rouse-like. Nonlocal contact → $\alpha < 0.5$.
	- Master curve: mean loop length $\ell$에 대해
...
- [[MOCs/📑 Journal reading - Polymer physics of nuclear organization and function]] — nuclear organization의 polymer physics 개관, MFPT 포함
